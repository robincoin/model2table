package com.wb.plugins.model2table.controller;
...
import com.wb.plugins.model2table.annotation.LengthCount;
import com.wb.plugins.model2table.annotation.Table;
import com.wb.plugins.model2table.command.Columns;
import com.wb.plugins.model2table.command.CreateTableParam;
...
public class CreateTableController {
	...
	public void start() {
		...
		pack = ConfigLoder.getProperty("mybatis.model.pack");
		// 不做任何事情
		...
		if ("none".equals(pack)) {
			log.info("\n配置mybatis.table.pack=none，不需要做任何事情");
			return;
		}
		createMysqlTable();
	...
	public void createMysqlTable() {
		...
		Set<Class<?>> classes = ClassTools.scanClasses(pack);
